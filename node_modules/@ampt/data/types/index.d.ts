...
export declare interface Data {
  ...
  get<T>(keys: Query | string[] | string, options?: getOptions | boolean): Promise<GetResponse<T>>
  getByLabel<T>(label: labels, keys: Query | string[], options?: getOptions | boolean): Promise<GetBatchResponse<T>>
  getByLabel<T>(label: labels, keys: Query | string[] | string, options?: getOptions | boolean): Promise<GetResponse<T>>
  scan<T>(options: scanOptions | boolean): Promise<ScanResponse<T>>
  set<T>(keys: any[], opts?: setBatchOptions | boolean): Promise<SetBatchResponse<T>>
  set<T>(keys: any[] | string, value: any, opts?: setOptions | boolean): Promise<SetResponse<T>>
